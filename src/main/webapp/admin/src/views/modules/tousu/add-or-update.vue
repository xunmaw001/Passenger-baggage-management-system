        ...
        <el-form
            ...
            <input id="gongzuorenyuanId" name="gongzuorenyuanId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="投诉内容" prop="tousuContent">
                ...
                <el-col :span="12" v-if="!(sessionTable == 'yonghu' && type != 'info')">
                    <el-form-item class="select" v-if="type!='info'"  label="是否处理" prop="chuliTypes">
                        <el-select v-model="ruleForm.chuliTypes" :disabled="ro.chuliTypes" placeholder="请选择是否处理">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="是否处理" prop="chuliValue">
                ...
                <el-col :span="24" v-if="!(sessionTable == 'yonghu' && type != 'info')">
                    <el-form-item v-if="type!='info'"  label="处理结果" prop="chuliText">
                        <el-input type="textarea"  :readonly="ro.chuliText" v-model="ruleForm.chuliText" placeholder="处理结果"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chuliText" label="处理结果" prop="chuliText">
                            <span v-html="ruleForm.chuliText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
