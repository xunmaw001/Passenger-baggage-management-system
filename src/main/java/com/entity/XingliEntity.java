 ...
 */
@TableName("xingli")
public class XingliEntity<T> implements Serializable {
    ...
    public String toString() {
        return "Xingli{" +
            "id=" + id +
            ", yonghuId=" + yonghuId +
            ", xingliUuidNumber=" + xingliUuidNumber +
            ", xingliName=" + xingliName +
            ", xingliPhoto=" + xingliPhoto +
            ", xingliTypes=" + xingliTypes +
            ", xingliZhongliang=" + xingliZhongliang +
            ", xingliZongjine=" + xingliZongjine +
            ", xingliContent=" + xingliContent +
            ", insertTime=" + insertTime +
            ", xingliZhuangtaiTypes=" + xingliZhuangtaiTypes +
            ", xingliYesnoTypes=" + xingliYesnoTypes +
            ", xingliYesnoText=" + xingliYesnoText +
            ", xingliShenheTime=" + xingliShenheTime +
